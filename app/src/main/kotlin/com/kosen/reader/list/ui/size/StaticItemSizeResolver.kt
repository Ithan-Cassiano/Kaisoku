...
class StaticItemSizeResolver(
	...
	private var textAppearanceResId = R.style.TextAppearance_Kosen_GridTitle
	...
	override fun attachToView(
		...
		if (widthThreshold == -1) {
			...
			textAppearanceResId = if (cellWidth < widthThreshold) {
				R.style.TextAppearance_Kosen_GridTitle_Small
			} else {
				R.style.TextAppearance_Kosen_GridTitle
			}
		}
		if (textView != null) {
