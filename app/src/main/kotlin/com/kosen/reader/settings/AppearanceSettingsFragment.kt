...
import com.kosen.reader.core.prefs.ScreenshotsPolicy
import com.kosen.reader.core.prefs.SearchSuggestionType
...
import com.kosen.reader.settings.protect.ProtectSetupActivity
import com.kosen.reader.settings.utils.ActivityListPreference
...
class AppearanceSettingsFragment :
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (BuildConfig.DEBUG) {
            DevFeatureBridge.bindAppearanceSettings(this)
        }
    }
