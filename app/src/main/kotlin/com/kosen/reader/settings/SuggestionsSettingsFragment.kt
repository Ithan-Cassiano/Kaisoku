...
import com.kosen.reader.settings.utils.MultiAutoCompleteTextViewPreference
import com.kosen.reader.settings.utils.TagsAutoCompleteProvider
...
class SuggestionsSettingsFragment : BasePreferenceFragment(R.string.suggestions),
	...
	override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
		if (settings.isSuggestionsEnabled && (key == AppSettings.KEY_SUGGESTIONS
				...
				|| key == AppSettings.KEY_NSFW_FILTER_STRICT)
		) {
			updateSuggestions()
		}
	}
