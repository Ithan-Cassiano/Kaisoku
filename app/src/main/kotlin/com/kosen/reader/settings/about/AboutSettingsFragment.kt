...
import com.kosen.reader.core.github.VersionId
import com.kosen.reader.core.github.isStable
...
class AboutSettingsFragment : BasePreferenceFragment(R.string.about) {
	...
	override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
		...
		findPreference<Preference>(AppSettings.KEY_LINK_GITHUB)?.isVisible = getString(R.string.url_github).isHttpUrl()
		findPreference<Preference>(AppSettings.KEY_LINK_MANUAL)?.isVisible = getString(R.string.url_user_manual).isHttpUrl()
	}
