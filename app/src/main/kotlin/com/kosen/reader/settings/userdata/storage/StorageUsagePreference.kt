package com.kosen.reader.settings.userdata.storage
...
import com.kosen.reader.core.ui.widgets.SegmentedBarView
import com.kosen.reader.core.util.FileSize
import com.kosen.reader.core.util.KosenColors
import com.kosen.reader.databinding.PreferenceMemoryUsageBinding
...
class StorageUsagePreference @JvmOverloads constructor(
	...
	override fun onBindViewHolder(holder: PreferenceViewHolder) {
		...
		val storageSegment = SegmentedBarView.Segment(
			...
			KosenColors.segmentColorRandom(context, Color.BLUE),
		)
		val pagesSegment = SegmentedBarView.Segment(
			usage?.pagesCache?.percent ?: 0f,
			KosenColors.segmentColorRandom(context, Color.GREEN),
		)
		val otherSegment = SegmentedBarView.Segment(
			usage?.otherCache?.percent ?: 0f,
			KosenColors.segmentColorRandom(context, Color.GRAY),
		)
