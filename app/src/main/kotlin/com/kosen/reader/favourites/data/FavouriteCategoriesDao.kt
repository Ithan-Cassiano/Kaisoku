...
abstract class FavouriteCategoriesDao {
	...
	@Query("SELECT category_id FROM favourite_categories WHERE deleted_at = 0 AND title = :title LIMIT 1")
	abstract suspend fun findCategoryIdByTitle(title: String): Long?
