...
class DetailsInteractor @Inject constructor(
	...
	fun observeIncognitoMode(mangaFlow: Flow<Manga?>): Flow<TriStateOption> {
		return mangaFlow
			...
			.combine(observeIncognitoModeSetting()) { manga, incognitoMode ->
				when (incognitoMode) {
					IncognitoMode.NO_HISTORY -> TriStateOption.ENABLED
					IncognitoMode.HIDDEN_HISTORY -> TriStateOption.DISABLED
					IncognitoMode.DISABLED -> when {
	...
	private fun observeIncognitoModeSetting() = settings.observeAsFlow(
