...
class ReadButtonDelegate(
	...
	override fun onMenuItemClick(item: MenuItem): Boolean {
		when (item.itemId) {
			...
			R.id.action_hide_from_main -> viewModel.hideFromMainHistory()
			R.id.action_show_in_main -> viewModel.showInMainHistory()
	...
	private fun prepareMenu(menu: Menu) {
		...
		menu.findItem(R.id.action_hide_from_main)?.isVisible = viewModel.canHideFromMainHistory()
		menu.findItem(R.id.action_show_in_main)?.isVisible = viewModel.canShowInMainHistory()
