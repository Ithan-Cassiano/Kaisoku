package com.kosen.reader.reader.ui.config
...
import com.kosen.reader.core.util.progress.IntPercentLabelFormatter
import com.kosen.reader.databinding.SheetReaderConfigBinding
import com.kosen.reader.reader.domain.PageLoader
import com.kosen.reader.reader.ui.ReaderViewModel
import com.kosen.reader.reader.ui.ScreenOrientationHelper
...
class ReaderConfigSheet :
    ...
    override fun onButtonChecked(
        ...
        viewBinding?.run {
            ...
            switchDoubleCoverPage.isEnabled = switchDoubleReader.isEnabled
