...
import com.kosen.reader.core.util.ext.hasVisibleChildren
import com.kosen.reader.core.util.ext.isRtl
...
import com.kosen.reader.core.util.ext.setValueRounded
import com.kosen.reader.databinding.LayoutReaderActionsBinding
import com.kosen.reader.details.ui.pager.ChaptersPagesSheet
import com.kosen.reader.details.ui.pager.ChaptersPagesSheet.Companion.TAB_PAGES
import com.kosen.reader.reader.ui.ReaderControlDelegate.OnInteractionListener
...
class ReaderActionsView @JvmOverloads constructor(
	...
	/**
	 * Re-tints the slider track to follow the bottom-bar opacity so a translucent bar doesn't end
	 * up with a fully-saturated slider painted on top of it. [bgAlpha] is 0–255 (255 = opaque).
	 */
