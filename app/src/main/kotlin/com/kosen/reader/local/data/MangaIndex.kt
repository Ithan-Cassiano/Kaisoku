...
import com.kosen.reader.parsers.util.json.getEnumValueOrNull
...
import com.kosen.reader.parsers.util.json.mapJSONToSet
...
class MangaIndex(source: String?) {
	...
	fun sortChaptersByName() {
		...
		val comparator = com.kosen.reader.core.util.AlphanumComparator()
