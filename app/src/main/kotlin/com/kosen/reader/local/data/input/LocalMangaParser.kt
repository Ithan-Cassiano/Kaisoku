package com.kosen.reader.local.data.input
...
import com.kosen.reader.core.model.isSameEntryAs
import com.kosen.reader.core.util.AlphanumComparator
import com.kosen.reader.core.util.MimeTypes
import com.kosen.reader.core.util.ext.URI_SCHEME_ZIP
import com.kosen.reader.core.util.ext.isDirectory
import com.kosen.reader.core.util.ext.isFileUri
import com.kosen.reader.core.util.ext.isImage
import com.kosen.reader.core.util.ext.isRegularFile
import com.kosen.reader.core.util.ext.isZipUri
import com.kosen.reader.core.util.ext.printStackTraceDebug
import com.kosen.reader.core.util.ext.toFileNameSafe
import com.kosen.reader.core.util.ext.toListSorted
import com.kosen.reader.local.data.MangaIndex
import com.kosen.reader.local.data.hasZipExtension
import com.kosen.reader.local.data.isZipArchive
import com.kosen.reader.local.data.output.LocalMangaOutput.Companion.ENTRY_NAME_INDEX
