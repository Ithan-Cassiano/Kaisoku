package com.kosen.reader.sync.domain
...
import com.kosen.reader.core.db.TABLE_FAVOURITES
import com.kosen.reader.core.db.TABLE_FAVOURITE_CATEGORIES
import com.kosen.reader.core.db.TABLE_HISTORY
import com.kosen.reader.core.db.TABLE_MANGA
import com.kosen.reader.core.db.TABLE_MANGA_TAGS
import com.kosen.reader.core.db.TABLE_TAGS
import com.kosen.reader.core.network.BaseHttpClient
import com.kosen.reader.core.util.ext.buildContentValues
import com.kosen.reader.core.util.ext.map
import com.kosen.reader.core.util.ext.mapToSet
import com.kosen.reader.core.util.ext.printStackTraceDebug
import com.kosen.reader.sync.data.SyncAuthApi
import com.kosen.reader.sync.data.SyncAuthenticator
import com.kosen.reader.sync.data.SyncInterceptor
import com.kosen.reader.sync.data.SyncSettings
import com.kosen.reader.sync.data.model.FavouriteCategorySyncDto
import com.kosen.reader.sync.data.model.FavouriteSyncDto
import com.kosen.reader.sync.data.model.HistorySyncDto
import com.kosen.reader.sync.data.model.MangaSyncDto
import com.kosen.reader.sync.data.model.MangaTagSyncDto
import com.kosen.reader.sync.data.model.SyncDto
