...
import com.kosen.reader.backups.domain.BackupObserver
import com.kosen.reader.core.db.MangaDatabase
import com.kosen.reader.core.exceptions.resolve.CaptchaHandler
import com.kosen.reader.core.image.AvifImageDecoder
import com.kosen.reader.core.image.CbzFetcher
import com.kosen.reader.core.image.MangaSourceHeaderInterceptor
...
import com.kosen.reader.core.parser.MangaLoaderContextImpl
import com.kosen.reader.core.parser.favicon.FaviconFetcher
import com.kosen.reader.core.prefs.AppSettings
import com.kosen.reader.core.ui.image.CoilImageGetter
import com.kosen.reader.core.ui.util.ActivityRecreationHandle
import com.kosen.reader.core.ui.util.ForegroundActivityHolder
import com.kosen.reader.core.util.AcraScreenLogger
import com.kosen.reader.core.util.FileSize
import com.kosen.reader.core.util.ext.connectivityManager
import com.kosen.reader.core.util.ext.isLowRamDevice
import com.kosen.reader.details.ui.pager.pages.MangaPageFetcher
import com.kosen.reader.details.ui.pager.pages.MangaPageKeyer
import com.kosen.reader.local.data.CacheDir
...
import com.kosen.reader.main.domain.CoverRestoreInterceptor
import com.kosen.reader.main.ui.protect.AppProtectHelper
import com.kosen.reader.main.ui.protect.ScreenshotPolicyHelper
import com.kosen.reader.parsers.MangaLoaderContext
import com.kosen.reader.search.ui.MangaSuggestionsProvider
import com.kosen.reader.sync.domain.SyncController
import com.kosen.reader.widget.WidgetUpdater
