...
import com.kosen.reader.core.exceptions.BadBackupFormatException
import com.kosen.reader.core.exceptions.CaughtException
import com.kosen.reader.core.exceptions.CloudFlareBlockedException
...
import com.kosen.reader.core.exceptions.EmptyMangaException
import com.kosen.reader.core.exceptions.IncompatiblePluginException
import com.kosen.reader.core.exceptions.InteractiveActionRequiredException
import com.kosen.reader.core.exceptions.NoDataReceivedException
import com.kosen.reader.core.exceptions.NonFileUriException
import com.kosen.reader.core.exceptions.ProxyConfigException
import com.kosen.reader.core.exceptions.SyncApiException
import com.kosen.reader.core.exceptions.UnsupportedFileException
import com.kosen.reader.core.exceptions.UnsupportedSourceException
import com.kosen.reader.core.exceptions.WrapperIOException
...
import com.kosen.reader.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import com.kosen.reader.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import com.kosen.reader.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import com.kosen.reader.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import com.kosen.reader.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
import com.kosen.reader.parsers.exception.AuthRequiredException
import com.kosen.reader.parsers.exception.ContentUnavailableException
import com.kosen.reader.parsers.exception.NotFoundException
import com.kosen.reader.parsers.exception.ParseException
import com.kosen.reader.parsers.exception.TooManyRequestExceptions
import com.kosen.reader.parsers.util.ifNullOrEmpty
import com.kosen.reader.scrobbling.common.domain.ScrobblerAuthRequiredException
import java.io.File
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.kosen.reader/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.kosen.reader/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
