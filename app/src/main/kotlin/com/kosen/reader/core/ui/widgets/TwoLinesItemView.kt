...
import com.kosen.reader.core.util.ext.getDrawableCompat
import com.kosen.reader.core.util.ext.resolveDp
import com.kosen.reader.core.util.ext.textAndVisible
import com.kosen.reader.databinding.ViewTwoLinesItemBinding
...
class TwoLinesItemView @JvmOverloads constructor(
	...
	init {
		...
		context.withStyledAttributes(
			...
			defStyleRes = R.style.Widget_Kosen_TwoLinesItemView,
		) {
