...
import com.kosen.reader.core.util.ext.iterator
...
private val ADULT_TAG_KEYWORDS = setOf(
	"hentai",
	"+18",
	"18+",
	"adult",
...
fun Manga.isAdultContent(): Boolean {
	...
	return tags.any { tag ->
		val title = tag.title.lowercase(java.util.Locale.ROOT)
		ADULT_TAG_KEYWORDS.any { keyword -> title == keyword }
	}
}
