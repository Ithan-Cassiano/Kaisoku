...
import com.kosen.reader.core.util.ext.restartApplication
...
import com.kosen.reader.scrobbling.common.ui.ScrobblerAuthHelper
...
class ExceptionResolver private constructor(
    ...
    private fun openInBrowser(url: String) {
        ...
        host.router.openBrowser(normalizedUrl, null, null)
    }
    ...
    companion object {
        ...
        fun getResolveStringId(e: Throwable) = when (e) {
            ...
            is ParseException -> if (e.url.isHttpUrl() || e.url.startsWith("//")) R.string.open_in_browser else 0
