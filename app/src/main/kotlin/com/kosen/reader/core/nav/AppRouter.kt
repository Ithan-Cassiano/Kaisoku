...
import com.kosen.reader.alternatives.ui.AlternativesActivity
import com.kosen.reader.backups.ui.backup.BackupDialogFragment
import com.kosen.reader.backups.ui.restore.RestoreDialogFragment
import com.kosen.reader.bookmarks.ui.AllBookmarksActivity
import com.kosen.reader.browser.BrowserActivity
import com.kosen.reader.browser.cloudflare.CloudFlareActivity
import com.kosen.reader.browser.cloudflare.CloudFlareHiddenActivity
import com.kosen.reader.core.exceptions.CloudFlareProtectedException
import com.kosen.reader.core.image.CoilMemoryCacheKey
import com.kosen.reader.core.model.FavouriteCategory
import com.kosen.reader.core.model.MangaSourceInfo
import com.kosen.reader.core.model.appUrl
import com.kosen.reader.core.model.getTitle
import com.kosen.reader.core.model.isBroken
import com.kosen.reader.core.model.isLocal
import com.kosen.reader.core.model.parcelable.ParcelableManga
import com.kosen.reader.core.model.parcelable.ParcelableMangaListFilter
import com.kosen.reader.core.model.parcelable.ParcelableMangaPage
...
import com.kosen.reader.core.ui.dialog.ErrorDetailsDialog
import com.kosen.reader.core.ui.dialog.buildAlertDialog
import com.kosen.reader.core.util.ext.connectivityManager
import com.kosen.reader.core.util.ext.findActivity
import com.kosen.reader.core.util.ext.getThemeDrawable
import com.kosen.reader.core.util.ext.printStackTraceDebug
import com.kosen.reader.core.util.ext.toFileOrNull
import com.kosen.reader.core.util.ext.toUriOrNull
import com.kosen.reader.core.util.ext.withArgs
import com.kosen.reader.details.ui.DetailsActivity
import com.kosen.reader.details.ui.pager.ChaptersPagesSheet
import com.kosen.reader.details.ui.related.RelatedMangaActivity
import com.kosen.reader.details.ui.scrobbling.ScrobblingInfoSheet
import com.kosen.reader.download.ui.dialog.DownloadDialogFragment
import com.kosen.reader.download.ui.list.DownloadsActivity
import com.kosen.reader.favourites.ui.FavouritesActivity
import com.kosen.reader.favourites.ui.categories.FavouriteCategoriesActivity
import com.kosen.reader.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.kosen.reader.favourites.ui.categories.select.FavoriteDialog
import com.kosen.reader.filter.ui.FilterCoordinator
import com.kosen.reader.filter.ui.sheet.FilterSheetFragment
import com.kosen.reader.filter.ui.tags.TagsCatalogSheet
import com.kosen.reader.history.ui.HistoryActivity
import com.kosen.reader.image.ui.ImageActivity
import com.kosen.reader.list.ui.config.ListConfigBottomSheet
import com.kosen.reader.list.ui.config.ListConfigSection
import com.kosen.reader.local.ui.ImportDialogFragment
import com.kosen.reader.local.ui.info.LocalInfoDialog
import com.kosen.reader.main.ui.MainActivity
import com.kosen.reader.main.ui.welcome.WelcomeSheet
import com.kosen.reader.suggestions.ui.SuggestionsFilterSheet
...
import com.kosen.reader.parsers.util.ellipsize
import com.kosen.reader.parsers.util.isNullOrEmpty
import com.kosen.reader.parsers.util.mapToArray
import com.kosen.reader.reader.ui.colorfilter.ColorFilterConfigActivity
import com.kosen.reader.reader.ui.config.ReaderConfigSheet
import com.kosen.reader.scrobbling.common.domain.model.ScrobblerService
import com.kosen.reader.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.kosen.reader.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.kosen.reader.search.domain.SearchKind
import com.kosen.reader.search.ui.MangaListActivity
import com.kosen.reader.search.ui.multi.SearchActivity
import com.kosen.reader.settings.SettingsActivity
import com.kosen.reader.settings.about.AppUpdateActivity
import com.kosen.reader.settings.override.OverrideConfigActivity
import com.kosen.reader.settings.reader.ReaderTapGridConfigActivity
import com.kosen.reader.settings.sources.auth.SourceAuthActivity
import com.kosen.reader.settings.sources.catalog.SourcesCatalogActivity
import com.kosen.reader.settings.sources.repo.MihonExtensionReposActivity
import com.kosen.reader.settings.sources.repo.MihonRepoExtensionsActivity
import com.kosen.reader.settings.storage.MangaDirectorySelectDialog
import com.kosen.reader.settings.storage.directories.MangaDirectoriesActivity
import com.kosen.reader.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.kosen.reader.stats.ui.StatsActivity
import com.kosen.reader.stats.ui.sheet.MangaStatsSheet
import com.kosen.reader.suggestions.ui.SuggestionsActivity
import com.kosen.reader.tracker.ui.updates.UpdatesActivity
import java.io.File
...
class AppRouter private constructor(
    ...
    fun showSuggestionsFilterSheet() {
        SuggestionsFilterSheet().showDistinct()
    }
