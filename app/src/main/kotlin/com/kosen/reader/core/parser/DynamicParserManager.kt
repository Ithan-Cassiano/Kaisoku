...
class PluginClassLoader(
	...
	override fun loadClass(name: String, resolve: Boolean): Class<*> {
		if (name == "com.kosen.reader.parsers.util.LinkResolver" ||
			name.startsWith("com.kosen.reader.parsers.util.LinkResolver$") ||
			name == "com.kosen.reader.parsers.MangaLoaderContext" ||
			name == "com.kosen.reader.parsers.MangaParserAuthProvider" ||
			(name.startsWith("com.kosen.reader.parsers.model.") &&
				name != "com.kosen.reader.parsers.model.MangaParserSource") ||
			name.startsWith("com.kosen.reader.parsers.config.") ||
			name.startsWith("com.kosen.reader.parsers.exception.")
		) {
			return super.loadClass(name, resolve)
		}
		if (name == "com.kosen.reader.parsers.MangaParser" ||
			name == "com.kosen.reader.parsers.model.MangaParserSource" ||
			name.startsWith("com.kosen.reader.parsers.site.") ||
			name.startsWith("com.kosen.reader.parsers.core.") ||
			name.startsWith("com.kosen.reader.core.parser.") ||
			name.startsWith("com.kosen.reader.parsers.util.") ||
			name.startsWith("com.kosen.reader.parsers.MangaParserFactory") ||
...
object DynamicParserManager {
	...
	fun loadParsersFromDirectory(context: Context, pluginDir: File) {
		...
		for (jar in pluginDir.listFiles { file -> file.extension == "jar" } ?: emptyArray()) {
			...
			try {
				val factory = classLoader.loadClass("com.kosen.reader.parsers.MangaParserFactoryKt")
				val enumClass = classLoader.loadClass("com.kosen.reader.parsers.model.MangaParserSource")
				val contextClass = classLoader.loadClass("com.kosen.reader.parsers.MangaLoaderContext")
