...
import com.kosen.reader.core.crash.GlobalCrashHandler
import com.kosen.reader.core.crash.isCrashProcess
import com.kosen.reader.core.db.MangaDatabase
import com.kosen.reader.core.os.AppValidator
import com.kosen.reader.core.os.RomCompat
import com.kosen.reader.core.parser.DynamicParserManager
import com.kosen.reader.core.parser.PluginFileLoader
import com.kosen.reader.core.prefs.AppSettings
import com.kosen.reader.core.work.AppWorkerFactory
...
import com.kosen.reader.settings.work.WorkScheduleManager
		...
		ProcessLifecycleOwner.get().lifecycle.addObserver(
			object : DefaultLifecycleObserver {
				override fun onStop(owner: LifecycleOwner) {
					settings.lockAllPrivateHistorySessions()
				}
			},
		)
