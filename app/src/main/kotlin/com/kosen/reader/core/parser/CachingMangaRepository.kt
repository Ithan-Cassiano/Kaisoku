...
import com.kosen.reader.core.cache.SafeDeferred
...
import com.kosen.reader.parsers.util.withChaptersSortedForReading
...
abstract class CachingMangaRepository(
	...
	suspend fun getDetails(manga: Manga, cachePolicy: CachePolicy): Manga = detailsMutex.withLock(manga.id) {
		...
		val details = asyncSafe {
			getDetailsImpl(manga).withChaptersSortedForReading()
		}
