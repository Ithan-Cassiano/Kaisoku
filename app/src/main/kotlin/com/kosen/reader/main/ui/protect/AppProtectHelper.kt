package com.kosen.reader.main.ui.protect

import android.app.Activity
import android.content.Intent
import android.os.Bundle
import org.acra.dialog.CrashReportDialog
import com.kosen.reader.core.crash.CrashDialogActivity
...
class AppProtectHelper @Inject constructor(private val settings: AppSettings) :
	...
	override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
		if (!isUnlocked && activity !is ProtectActivity && activity !is CrashReportDialog && activity !is CrashDialogActivity) {
