package com.kosen.reader.download.ui.worker
...
import com.kosen.reader.core.model.ids
...
import com.kosen.reader.core.util.Throttler
import com.kosen.reader.core.util.ext.MimeType
import com.kosen.reader.core.util.ext.awaitFinishedWorkInfosByTag
import com.kosen.reader.core.util.ext.awaitUpdateWork
import com.kosen.reader.core.util.ext.awaitWorkInfosByTag
import com.kosen.reader.core.util.ext.deleteAwait
import com.kosen.reader.core.util.ext.deleteWork
import com.kosen.reader.core.util.ext.deleteWorks
import com.kosen.reader.core.util.ext.ensureSuccess
import com.kosen.reader.core.util.ext.getDisplayMessage
import com.kosen.reader.core.util.ext.getWorkInputData
import com.kosen.reader.core.util.ext.getWorkSpec
import com.kosen.reader.core.util.ext.isImage
import com.kosen.reader.core.util.ext.openSource
...
import com.kosen.reader.core.util.ext.withTicker
import com.kosen.reader.core.util.ext.writeAllCancellable
import com.kosen.reader.core.util.progress.RealtimeEtaEstimator
import com.kosen.reader.download.domain.DownloadProgress
import com.kosen.reader.download.domain.DownloadState
...
import com.kosen.reader.local.data.TempFileFilter
import com.kosen.reader.local.data.input.LocalMangaParser
import com.kosen.reader.local.data.output.LocalMangaOutput
...
class DownloadWorker @AssistedInject constructor(
	...
	private suspend fun downloadFile(
		...
		repository: com.kosen.reader.core.parser.MangaRepository? = null,
		page: MangaPage? = null,
	): File {
