...
import com.kosen.reader.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.kosen.reader.download.PAUSE"
		private const val ACTION_RESUME = "com.kosen.reader.download.RESUME"
		private const val ACTION_SKIP = "com.kosen.reader.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.kosen.reader.download.SKIP_ALL"
