package com.kosen.reader.scrobbling.kitsu.ui
...
import com.kosen.reader.databinding.ActivityKitsuAuthBinding
...
class KitsuAuthActivity : BaseActivity<ActivityKitsuAuthBinding>(),
	...
	private fun continueAuth() {
		...
		val url = "kosen://kitsu-auth?code=" + "$email;$password".urlEncoded()
