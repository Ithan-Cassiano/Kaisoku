package com.kosen.reader.scrobbling.kitsu.data
...
import com.kosen.reader.core.util.ext.parseJsonOrNull
import com.kosen.reader.parsers.util.await
import com.kosen.reader.parsers.util.json.getFloatOrDefault
import com.kosen.reader.parsers.util.json.getIntOrDefault
...
import com.kosen.reader.scrobbling.common.data.ScrobblerRepository
...
import com.kosen.reader.scrobbling.common.domain.model.ScrobblerMangaInfo
import com.kosen.reader.scrobbling.common.domain.model.ScrobblerService
import com.kosen.reader.scrobbling.common.domain.model.ScrobblerUser
import com.kosen.reader.scrobbling.kitsu.data.KitsuInterceptor.Companion.VND_JSON
...
class KitsuRepository(
	...
	override val oauthUrl: String = "kosen+kitsu://auth"
