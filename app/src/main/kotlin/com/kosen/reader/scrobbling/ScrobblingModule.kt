package com.kosen.reader.scrobbling
...
import com.kosen.reader.core.network.CurlLoggingInterceptor
import com.kosen.reader.scrobbling.anilist.data.AniListAuthenticator
import com.kosen.reader.scrobbling.anilist.data.AniListInterceptor
import com.kosen.reader.scrobbling.anilist.domain.AniListScrobbler
import com.kosen.reader.scrobbling.common.data.ScrobblerStorage
...
import com.kosen.reader.scrobbling.common.domain.model.ScrobblerType
import com.kosen.reader.scrobbling.kitsu.data.KitsuAuthenticator
import com.kosen.reader.scrobbling.kitsu.data.KitsuInterceptor
import com.kosen.reader.scrobbling.kitsu.data.KitsuRepository
import com.kosen.reader.scrobbling.kitsu.domain.KitsuScrobbler
import com.kosen.reader.scrobbling.mal.data.MALAuthenticator
import com.kosen.reader.scrobbling.mal.data.MALInterceptor
import com.kosen.reader.scrobbling.mal.domain.MALScrobbler
import com.kosen.reader.scrobbling.shikimori.data.ShikimoriAuthenticator
import com.kosen.reader.scrobbling.shikimori.data.ShikimoriInterceptor
import com.kosen.reader.scrobbling.shikimori.domain.ShikimoriScrobbler
