...
import com.kosen.reader.databinding.ItemDevSuggestionsEmptyBinding
...
import com.kosen.reader.explore.ui.model.DevSuggestionsEmptyItem
...
fun devExploreRecommendationItemAD(
	...
	val adapter = BaseListAdapter<MangaCompactListModel>()
		.addDelegate(ListItemType.MANGA_LIST, devRecommendationMangaItemAD(itemClickListener, progressProvider))
...
fun devRecommendationMangaItemAD(
	itemClickListener: OnListItemClickListener<Manga>,
	progressProvider: () -> Map<Long, ReadingProgress?>,
...
fun devSuggestionsEmptyAD(
	listener: ExploreListEventListener,
) = adapterDelegateViewBinding<DevSuggestionsEmptyItem, ListModel, ItemDevSuggestionsEmptyBinding>(
	{ layoutInflater, parent -> ItemDevSuggestionsEmptyBinding.inflate(layoutInflater, parent, false) },
) {
...
fun devExploreSourceListItemAD(
	...
	bind {
		...
		val statusLabel = when (status) {
			SourceHealthTracker.Status.OK -> context.getString(R.string.dev_source_status_ok)
			SourceHealthTracker.Status.UNSTABLE -> context.getString(R.string.dev_source_status_unstable)
			SourceHealthTracker.Status.OFFLINE -> context.getString(R.string.dev_source_status_offline)
		}
...
fun devExploreSourceGridItemAD(
	listener: OnListItemClickListener<MangaSourceItem>,
